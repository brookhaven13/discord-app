...
const formSchema = z.object({
  name: z
    ...
    .refine((name) => name !== "general", { message: "General is reserved" }),
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="text-black bg-zinc-300/50 border-0 focus:ring-0 ring-offset-0 focus:ring-offset-0 capitalize outline-none">
